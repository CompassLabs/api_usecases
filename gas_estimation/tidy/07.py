...
if __name__ == "__main__":
    ...
    steps_dict = output_data["process_requests"]

    total_est_gas = sum(item["EstGas"] for item in steps_dict)
    total_used_gas = sum(item["UsedGas"] for item in steps_dict)
