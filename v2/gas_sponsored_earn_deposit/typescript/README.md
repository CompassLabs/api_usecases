# Gas-Sponsored Earn Deposit - TypeScript Example

This example demonstrates how to deposit into a Morpho vault with gas sponsorship using the Compass API TypeScript SDK.
...
1. **Get EIP-712 typed data**: Calls `/v2/earn/manage` with `gasSponsorship: true` to get EIP-712 typed data
