# CCTP Bridging - Python Example

This example demonstrates how to bridge USDC between chains using Circle's Cross-Chain Transfer Protocol (CCTP) via the Compass API Python SDK.
